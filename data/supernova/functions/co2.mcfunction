execute at @e[type=minecraft:armor_stand,limit=12,distance=0..100,name="co2"] run particle minecraft:campfire_cosy_smoke ~ ~ ~ 0 -5 0 0.2 0 force @a
schedule function #minecraft:co2_2 9 append
